...
* [Create the web application](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#create-the-web-application)
* [Adding IdentityServer](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-identityserver)
* [Configuring IdentityServer - Clients](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#configuring-identityserver---clients)
* [Configuring IdentityServer - Users](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#configuring-identityserver---users)
* [Adding Startup](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-startup)
* [RAMMFAR](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#rammfar)
* [Adding and configuring the OpenID Connect authentication middleware](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-and-configuring-the-openid-connect-authentication-middleware)
* [Adding a protected resource and showing claims](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-a-protected-resource-and-showing-claims)
* [Authentication and claims](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#authentication-and-claims)
* [Adding role claims and scope](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-role-claims-and-scope)
* [Changing the middleware configuration to ask for roles](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#changing-the-middleware-configuration-to-ask-for-roles)
* [Claims transformation](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#claims-transformation)
* [Authorization](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#authorization)
* [More authorization and dealing with access denied scenarios](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#more-authorization-and-dealing-with-access-denied-scenarios)
* [Adding Logout] (https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-logout)
* [Adding Google Authentication](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-google-authentication)

**Part 2 - Adding and calling a Web API**
* [Adding the Web API Project](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-the-web-api-project)
* [Adding a Test Controller](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#adding-a-test-controller)
* [Wiring up Web API and Security in Startup](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#wiring-up-web-api-and-security-in-startup)
* [Registering the API in IdentityServer](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#registering-the-api-in-identityserver)
* [Registering a Web API Client](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#registering-a-web-api-client)
* [Calling the API](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#calling-the-api)
* [Calling the API on behalf of a User](https://github.com/thinktecture/Thinktecture.IdentityServer.v3/wiki/Getting-started#calling-the-api-on-behalf-of-the-user)
...
Also don't forget to update the start URL in your project properties.
...
Next we want to call the API using the user's idenity. This is accomplished by adding the `sampleApi` scope to the list of scopes in the OpenID Connect middleware configuration. We also need to indicate that we want to request an access token by changing the response type:
